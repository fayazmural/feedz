      ...
      },
      {
        ...
        cell: (info) =>
          info.getValue() === null ? (
            ...
            <Ratings rating={info.getValue() as number} />
          ),
  ...
  return typeof firstValue === "number" ? (
    <div className="flex space-x-2" onClick={(e) => e.stopPropagation()}>
      <input
        ...
        placeholder={`Min`}
        className="w-24 border shadow rounded px-3 py-1"
      />
      <input
        type="number"
        ...
        placeholder={`Max`}
        className="w-24 border px-3 py-1 shadow rounded"
      />
    </div>
  ) : (
    <input
      className="w-36 border shadow rounded px-3 py-1 text-slate-800 font-normal"
